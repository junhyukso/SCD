...
def generate(
    ...
    save_path = 'generated_samples_original'
    ...
    print(f"inner elapsed time: {t}")
    logging.info(f"inner elapsed time: {t}")
    ...
    for i in range(parallel_size):
        final_save_path = os.path.join(save_path, f"{prompt_input[:20]}.jpg".format(i))
        PIL.Image.fromarray(visual_img[i]).save(final_save_path)
