...
class MultiTokensVLLogitsProcessor(LogitsProcessor):
    ...
    def __init__(
        ...
        self.image_start_token_id = image_start_token_id # 100016
        self.image_end_token_id = image_end_token_id # 100593
        ...
        self.image_token_list = [i for i in range(0, 16384)]
        ...
        self.suppress_token_mask = torch.isin(self.vocab_tensor, self.suppress_tokens) # not [   0,    1,    2,  ..., 16381, 16382, 16383]
