...
from scheduler.jacobi_iteration_lumina_mgpt_GS import renew_pipeline_sampler
...
os.makedirs(f"./SCD_GS/"+folder_name, exist_ok=True)
for seed in seeds:
    ...
    for i, q_image_content_condition in enumerate(q_image_content_conditions):
        ...
        result_image.save(f"./SCD_GS/{folder_name}/" + output_file_name)
